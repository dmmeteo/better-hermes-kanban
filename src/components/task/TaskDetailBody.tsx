...
export function TaskDetailBody({
  ...
  return (
    <div className={cn('flex min-h-0 flex-1 flex-col gap-4', layout === 'mobile' && 'gap-3')} data-testid="task-detail-body">
      ...
      <section data-testid="task-description-section" className="rounded-xl border border-border/60 bg-card/40 p-3">
        <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-muted-foreground">Description</p>
        <InlineEditField
          value={task.description}
          onSave={handleSaveDescription}
          as="textarea"
          textareaRows={layout === 'mobile' ? 5 : 8}
